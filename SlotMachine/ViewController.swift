...
//  SlotMachine
//
//  Created by Juice Rios on 1/26/15.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Sets up the second container in addition to initializing other variables
        hardReset()
    ...
    func spinButtonPressed(button: UIButton) {
        ...
        if currentBet == 0 {
            showAlertWithText(header: "No Bet Placed", message: "You must make a bet before spinning")
            return
        }
        
        //call helper function to remove old subviews before adding new ones
